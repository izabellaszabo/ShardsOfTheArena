...
ARENASHARDS_API UClass* Z_Construct_UClass_ACombatEnemySpawner();
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatEnemySpawner_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatActivatable_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemySpawner, ICombatActivatable), false },  // 577423446
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_ArenaShards_Source_ArenaShards_Variant_Combat_AI_CombatEnemySpawner_h__Script_ArenaShards_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatEnemySpawner, ACombatEnemySpawner::StaticClass, TEXT("ACombatEnemySpawner"), &Z_Registration_Info_UClass_ACombatEnemySpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatEnemySpawner), 1741946722U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaShards_Source_ArenaShards_Variant_Combat_AI_CombatEnemySpawner_h__Script_ArenaShards_3295031619(TEXT("/Script/ArenaShards"),
	Z_CompiledInDeferFile_FID_ArenaShards_Source_ArenaShards_Variant_Combat_AI_CombatEnemySpawner_h__Script_ArenaShards_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ArenaShards_Source_ArenaShards_Variant_Combat_AI_CombatEnemySpawner_h__Script_ArenaShards_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
